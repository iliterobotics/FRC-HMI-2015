...
2012 J Knight
Modified to add basic width passed in to ctor, and modified package.
Added default constructor, re-formatted indents/etc
 */

package org.ilite.util.gui.stroke;
...
public class WobbleStroke implements Stroke
{
  ...
  public WobbleStroke(float detail, float amplitude, float width)
  {
    this.detail = detail;
...
//        first = false;
  ...
  {
    return x + (float) Math.random() * amplitude * 2 ;
  }
